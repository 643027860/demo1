...
<!--              <img v-if="type===3" :src="imageUrl" class="avatar">-->
            ...
            <!--          <YULANVIDEO style="height: 180px;width: 200px;" v-show="isShow==='block'"></YULANVIDEO>-->
          </el-form-item>
...
<!--            <img id="myBiaoZhu" src="./1.png" alt="" class="biaoZhuTu">-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        wsPath:'ws://bde5587e71261532.natapp.cc:8252/realTime', //与后台握手地址
        wsPath1:'ws://bde5587e71261532.natapp.cc:8252/deepin', //与深度学习握手地址
