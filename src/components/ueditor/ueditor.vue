          ...
          .then(response=>{
            ...
            UE.Editor.prototype.getActionUrl = function(action) {
              ...
              if (action == 'uploadimage' || action == 'uploadscrawl' || action == 'uploadimage') {
                return 'http://124.70.40.181:8257/ssmweb/upload.do';
                //上传视频
              }else if(action == "uploadvideo"){
                return 'http://124.70.40.181:8257/ssmweb/videoUpload';
              }
              //上传附件
              else if(action == "uploadfile"){
                return 'http://124.70.40.181:8257/ssmweb/uploadVideoFiles.do';
              }
              //默认
              else {
